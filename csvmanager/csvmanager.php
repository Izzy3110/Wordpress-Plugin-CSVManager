...
add_action('admin_post_upload_csv', 'my_callback_fn');
function my_callback_fn($data) {
	header("Location: admin.php?page=csvmanager%2Fcsvmanager.php&action=upload&result=success");
}
...
function csv_manager_plugin_settings_page() {
    ?>
    <div class="wrap">
    <h1>Your Plugin Name</h1>

    <form method="post" action="options.php">
        <?php settings_fields( 'csv-manager-plugin-settings-group' ); ?>
        <?php do_settings_sections( 'csv-manager-plugin-settings-group' ); ?>
